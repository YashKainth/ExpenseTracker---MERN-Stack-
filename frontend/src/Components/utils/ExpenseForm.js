...
function ExpenseForm() {
    ...
    useEffect(() => {
        ...
        setInputState(inputState => ({ ...inputState, email: loggedEmail }));
    }, [loggedEmail]);
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className="categoryinput">
                ...
                />
                <button type="button" onClick={() => handleAddCategory(newCategory)} className='new-category'>Add Category</button>
            </div>
            <div className="input-control">
                <textarea
                    name="description"
